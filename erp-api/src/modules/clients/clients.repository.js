...
const CLIENT_COLUMN_CANDIDATES = Object.freeze({
  ...
  paymentMethodId: ["ID_FORMA_PAGAMENTO", "ID_FPGTO", "ID_FORMAPAGAMENTO"],
  paymentTermId: ["ID_CONDICAO_PAGAMENTO", "ID_PRAZO", "ID_COND_PAGTO", "PRAZO"],
...
function buildSelectList(schema) {
  ...
  const parts = [
    ...
    selectIfPresent("cl", c.paymentTermId, "ID_CONDICAO_PAGAMENTO"),
